      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-24">
        <div className="z-10 max-w-5xl w-full items-center justify-between text-sm lg:flex">
          <div class="flex items-center h-full">
            <h1 className='text-2xl'>Expenses App</h1>
          </div>
        ...
        <dialog ref={modalRef} className="modal modal-bottom sm:modal-middle">
          <div className="modal-box">
            ...
            <div className="w-full flex justify-between py-4 space-x-4">
              <input type="text" placeholder="Month" className="input input-bordered w-full max-w-xs" />
              <input type="text" placeholder="Year" className="input input-bordered w-full max-w-xs" />
            </div>
            <div className="w-full">
              <input type="text" placeholder="Income" className="input input-bordered w-full" />
            </div>
